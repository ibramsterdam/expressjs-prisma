...
-- AddForeignKey
ALTER TABLE "UserOnDatapodwithRole" ADD CONSTRAINT "UserOnDatapodwithRole_datapodId_fkey" FOREIGN KEY ("datapodId") REFERENCES "Datapod"("id") ON DELETE CASCADE ON UPDATE CASCADE;
