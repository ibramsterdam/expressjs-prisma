...
export async function updatePermissionController(
    ...
    try {
        const updatedPermission = await updatePermissionService(Number(req.params.id), req.body)
...
export async function deletePermissionController(
    ...
    try {
        const deletedPermission = await deletePermissionService(Number(req.params.id))
